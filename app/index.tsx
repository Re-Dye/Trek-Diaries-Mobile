        ...
        <View className="w-full justify-center items-center min-h-[90vh] px-5">
          ...
          <View className="mt-5">
            <Text className="text-white text-2xl font-bold text-center">
              Meet trekk enthusiasts and connect with {""}
              <Text className="text-green-500">TrekDiaries</Text>
            </Text>
          </View>
          <Text className="text-sm text-gray-100 text-center mt-7 font-pregular">
            Embark on an Adventure: Connect together and Explore Limitless
            Trails with TrekDiaries
          </Text>
          <CustomButton
