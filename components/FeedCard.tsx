  ...
  return (
    <View>
      <View className='m-3 p-4 bg-black-100 rounded-2xl'>
        ...
        <View className='m-2'>
          <Text className='text-white font-pbook my-2 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste cum, quo error officia officiis vitae ipsam enim magnam excepturi ratione beatae inventore. Cumque aliquam blanditiis temporibus. Harum tempore expedita vitae.</Text>
        </View>
